...
HD_PWD='D:/CAPSTONE_FINAL_DESIGN/balloon_final/balloon_final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xc7_top_level.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xc7_top_level.tcl
