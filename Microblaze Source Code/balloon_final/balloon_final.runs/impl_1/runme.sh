...
HD_PWD='D:/CAPSTONE_FINAL_DESIGN/balloon_final/balloon_final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log xc7_top_level.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source xc7_top_level.tcl -notrace
