...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = lfsr_iface
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = mem_addr
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = mem_data
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = PmodSD
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = PmodSD_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = PmodSD
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = PmodSD_2
END
