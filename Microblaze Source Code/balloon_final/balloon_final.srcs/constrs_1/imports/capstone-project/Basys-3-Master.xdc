...
##Pmod Header JA
#Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports {ja_1}]
	set_property IOSTANDARD LVCMOS33 [get_ports {ja_1}]
#Sch name = JA2
set_property PACKAGE_PIN L2 [get_ports {ja_2}]
	set_property IOSTANDARD LVCMOS33 [get_ports {ja_2}]
#Sch name = JA3
set_property PACKAGE_PIN J2 [get_ports {ja_3]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {ja_3}]
#Sch name = JA4
set_property PACKAGE_PIN G2 [get_ports {ja_4}]
	set_property IOSTANDARD LVCMOS33 [get_ports {ja_5}]
#Sch name = JA7
set_property PACKAGE_PIN H1 [get_ports {ja_7}]
	set_property IOSTANDARD LVCMOS33 [get_ports {ja_7}]
#Sch name = JA8
set_property PACKAGE_PIN K2 [get_ports {ja_8}]
	set_property IOSTANDARD LVCMOS33 [get_ports {ja_8}]
#Sch name = JA9
set_property PACKAGE_PIN H2 [get_ports {ja_9}]
	set_property IOSTANDARD LVCMOS33 [get_ports {ja_9}]
#Sch name = JA10
set_property PACKAGE_PIN G3 [get_ports {ja_10]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {ja_10}]
